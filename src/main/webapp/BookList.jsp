        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th>
                            <span class="glyphicon glyphicon-align-justify"></span> ID
                        </th>
                        <th>
                            <span class="glyphicon glyphicon-book"></span> Titulo
                        </th>
                        <th>
                            <span class="glyphicon glyphicon-user"></span> Autor
                        </th>
                        <th>
                            <span class="glyphicon glyphicon-usd"></span> Preco
                        </th>
                        <th>
                            <span class="glyphicon glyphicon-wrench"></span> Ações
                        </th>
                    </tr>
                    <c:forEach var="book" items="${listaBook}">
                        <tr>
                            ...
                            <td>
                                <a href="<%=request.getContextPath()%>/bstore/edit?id=<c:out default="" escapeXml="" value='${book.id}' />">
